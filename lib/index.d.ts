 ...
 */
export declare function compressImage(input: string | Buffer, options?: CompressionOptions): Promise<Buffer>;
export declare function compressMultipleImages(inputs: (string | Buffer)[], options?: CompressionOptions): Promise<Buffer[]>;
