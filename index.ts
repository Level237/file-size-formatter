...
export async function compressImage(input: string | Buffer, options: CompressionOptions = {}): Promise<Buffer> {
...
export async function compressMultipleImages(inputs: (string | Buffer)[], options: CompressionOptions = {}): Promise<Buffer[]> {
