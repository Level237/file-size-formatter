...
exports.compressMultipleImages = exports.compressImage = exports.formatFileSize = void 0;
...
const compressImage = async (input, options = {}) => {
    ...
    try {
        ...
        if (sizeMB > maxSizeMB) {
            image = (0, sharp_1.default)(input).resize({
                width: maxWidth,
                height: maxHeight,
                fit: 'inside',
                withoutEnlargement: true,
...
const compressMultipleImages = async (inputs, options = {}) => {
    ...
    const promises = inputs.map((input) => (0, exports.compressImage)(input, options));
...
exports.default = {
    ...
    compressMultipleImages: exports.compressMultipleImages
};
